...
public record PublisherDTO(
        ...
        @Schema(description = "The unique name of the publisher implementation.", example = "dependency-check-publisher", required = true)
        String name,

        @Schema(description = "The version of the publisher to use (optional).", example = "1.0.0")
        String version,

        @Schema(description = "Arbitrary configuration options required by the specific publisher.", example = "{\"foo\": \"bar\", \"x\": \"y\"}")
